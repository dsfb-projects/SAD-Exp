...
export default function Dashboard({ stats, onNavigate }: Props) {
  const cards = [
    ...
    { label: 'Projetos', value: stats?.orders ?? '—', icon: ShoppingCart, color: '#22c55e', page: 'orders' as Page },
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
        <div className="card">
          ...
          {[
            ...
            { step: '3', label: 'Registre os projetos', desc: 'Ou importe via planilha Excel', page: 'orders' as Page },
        ...
        <div className="card">
          ...
          <p style={{ color: 'var(--muted)', fontSize: 13, lineHeight: 1.6, marginBottom: 16 }}>
            Importe planilhas Excel com produtos e projetos diretamente para o banco de dados.
          ...
          <div style={{ background: 'var(--surface2)', borderRadius: 8, padding: '12px 14px', marginBottom: 16 }}>
            <div style={{ fontSize: 12, fontWeight: 600, color: 'var(--muted)', marginBottom: 6 }}>COLUNAS ESPERADAS — PROJETOS</div>
            <code style={{ fontSize: 12, color: 'var(--accent)' }}>N° do Projeto, Cliente, Materiais</code>
          </div>
